...
describe('node-otr-native', function(){
  describe('AKE Phases 1 and 2 as Alice', function(){
    before(function(){
    ...
    after(function(){
      if(xmpp_config.xmpp_dev == true) cl.send(new xmpp.Element('message', { to: xmpp_config.interlocutor, type: 'chat'}).c('body').t(dh_key));
    });
  });
});
